...
func (_c *SkillCreate) SetVersion(v string) *SkillCreate {
...
func (_c *SkillCreate) SetURI(v string) *SkillCreate {
...
func (_c *SkillCreate) check() error {
	...
	if _, ok := _c.mutation.Version(); !ok {
		return &ValidationError{Name: "version", err: errors.New(`ent: missing required field "Skill.version"`)}
	}
	...
	if _, ok := _c.mutation.URI(); !ok {
		return &ValidationError{Name: "uri", err: errors.New(`ent: missing required field "Skill.uri"`)}
	}
