...
func (_c *DepartmentCreate) SetLitellmTeamID(v string) *DepartmentCreate {
	_c.mutation.SetLitellmTeamID(v)
	return _c
}

// SetNillableLitellmTeamID sets the "litellm_team_id" field if the given value is not nil.
func (_c *DepartmentCreate) SetNillableLitellmTeamID(v *string) *DepartmentCreate {
	if v != nil {
		_c.SetLitellmTeamID(*v)
	}
	return _c
}
