...
func EnvironmentID(v uuid.UUID) predicate.Agent {
	return predicate.Agent(sql.FieldEQ(FieldEnvironmentID, v))
}
...
func EnvironmentIDEQ(v uuid.UUID) predicate.Agent {
	return predicate.Agent(sql.FieldEQ(FieldEnvironmentID, v))
}

// EnvironmentIDNEQ applies the NEQ predicate on the "environment_id" field.
func EnvironmentIDNEQ(v uuid.UUID) predicate.Agent {
	return predicate.Agent(sql.FieldNEQ(FieldEnvironmentID, v))
}

// EnvironmentIDIn applies the In predicate on the "environment_id" field.
func EnvironmentIDIn(vs ...uuid.UUID) predicate.Agent {
	return predicate.Agent(sql.FieldIn(FieldEnvironmentID, vs...))
}

// EnvironmentIDNotIn applies the NotIn predicate on the "environment_id" field.
func EnvironmentIDNotIn(vs ...uuid.UUID) predicate.Agent {
	return predicate.Agent(sql.FieldNotIn(FieldEnvironmentID, vs...))
}

// EnvironmentIDGT applies the GT predicate on the "environment_id" field.
func EnvironmentIDGT(v uuid.UUID) predicate.Agent {
	return predicate.Agent(sql.FieldGT(FieldEnvironmentID, v))
}

// EnvironmentIDGTE applies the GTE predicate on the "environment_id" field.
func EnvironmentIDGTE(v uuid.UUID) predicate.Agent {
	return predicate.Agent(sql.FieldGTE(FieldEnvironmentID, v))
}

// EnvironmentIDLT applies the LT predicate on the "environment_id" field.
func EnvironmentIDLT(v uuid.UUID) predicate.Agent {
	return predicate.Agent(sql.FieldLT(FieldEnvironmentID, v))
}

// EnvironmentIDLTE applies the LTE predicate on the "environment_id" field.
func EnvironmentIDLTE(v uuid.UUID) predicate.Agent {
	return predicate.Agent(sql.FieldLTE(FieldEnvironmentID, v))
}

// EnvironmentIDIsNil applies the IsNil predicate on the "environment_id" field.
func EnvironmentIDIsNil() predicate.Agent {
	return predicate.Agent(sql.FieldIsNull(FieldEnvironmentID))
}

// EnvironmentIDNotNil applies the NotNil predicate on the "environment_id" field.
func EnvironmentIDNotNil() predicate.Agent {
	return predicate.Agent(sql.FieldNotNull(FieldEnvironmentID))
}

// HasVirtualKeys applies the HasEdge predicate on the "virtual_keys" edge.
func HasVirtualKeys() predicate.Agent {
...
// HasVirtualKeysWith applies the HasEdge predicate on the "virtual_keys" edge with a given conditions (other predicates).
func HasVirtualKeysWith(preds ...predicate.VirtualKey) predicate.Agent {
	return predicate.Agent(func(s *sql.Selector) {
		step := newVirtualKeysStep()
